...
for i in range(0, n):
    ele = input()
    Totalstudent.append(ele)  # adding the element
print("Original list of students in SEComp : " + str(Totalstudent))
...
while flag==1:
    ...
    if ch==1:
        ...
        print("Number of students who play neither cricket nor badminton : ", nCnB(Totalstudent,Cricket,Badminton))
        a = input("\n\nDo you want to continue (yes/no) :")
        if a == "yes":
            flag = 1
